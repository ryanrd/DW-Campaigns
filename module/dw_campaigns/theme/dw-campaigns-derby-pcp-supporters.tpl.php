<?php
    ...
    foreach($supporters as $key => $supporter) {
        ...
        db_query("insert into {donations_as_$num_per_page} (name, photo, email, amount, location, donationdate, note) VALUES ('%s', '%s', '%s', '%s', '%s', '%s', '%s')", $name, $photo, $email, $amount, $location, $date, $note);
    }
